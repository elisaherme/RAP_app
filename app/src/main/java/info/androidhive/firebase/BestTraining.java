...
public class BestTraining extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GraphView graph = (GraphView) findViewById(R.id.graphBT);
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener(){
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(BestTraining.this, "Chest Pressure / Time = " +dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        series2.setOnDataPointTapListener(new OnDataPointTapListener(){
            ...
            public void onTap(Series series2, DataPointInterface dataPoint) {
                Toast.makeText(BestTraining.this, "Seat Pressure / Time = " +dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        series3.setOnDataPointTapListener(new OnDataPointTapListener(){
            ...
            public void onTap(Series series3, DataPointInterface dataPoint) {
                Toast.makeText(BestTraining.this, "Speed / Time = " +dataPoint, Toast.LENGTH_SHORT).show();
            }
        });
    }
